...
/**
 * Helper methods for creating {@link com.urosjarc.dbanalyser.shared.FlipTable tables} from various different data sets.
 */
public final class FlipTableConverters {
  ...
  public static String fromObjects(String[] headers, Object[][] data) {
    ...
    return com.urosjarc.dbanalyser.shared.FlipTable.of(headers, dataArray);
  }
  ...
  public static <T> String fromIterable(Iterable<T> rows, Class<T> rowType) {
    ...
    return com.urosjarc.dbanalyser.shared.FlipTable.of(headerArray, dataArray);
  }
